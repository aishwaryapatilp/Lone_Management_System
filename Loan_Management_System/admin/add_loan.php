...
?>
<h2 align="center" style="color:#00FFFF;text-decoration:underline">Allot Loan</h2>
<form method="post">
...
echo "<option value='".$r1['group_id']."'>".$r1['group_name']."</option>";
	...
	<div class="row" style="margin-top:10px">
		...
		<div class="col-sm-5">
		<input type="text" name="intereset" id="interest" value="6" readonly="true" class="form-control" required/></div>
	</div>
