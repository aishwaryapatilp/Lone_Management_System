...
<?php 
	...
	<div class="row" style="margin-top:10px">
		...
		<select name="district" onchange="showDivision(this.value)" id="district" class="form-control" >
			...
			<option value="">Gadaga</option>
			<option value="">Mysore</option>
			<option value="">Kodagu</option>
			<option value="">Davanagere</option>
			<option value="">Hasana</option>
			<option value="">Uttara kannada</option>
			<option value="">Dakshinakannada</option>
			<option value="">Belagavi</option>
			<option value="">Tumkuru</option>
			<option value="">Chikkamagaluru</option>
			<option value="">Bidar</option>
			<option value="">Karvar</option>
			<option value="">Hubballi</option>
			<option value="">Dharvadh</option>
